...
#if 1
typedef enum {
	TEMP_BELOW_NEG_10 = 0, // < -10
	TEMP_NEG_10_TO_POS_45,// -10~45
	TEMP_POS_45_TO_POS_55, // 45~55
	TEMP_POS_55_TO_POS_60, // 55 ~60
	TEMP_ABOVE_POS_60	   // > 60
} temp_state_enum;
#else
typedef enum {
	TEMP_BELOW_NEG_10 = 0,
...
#define TEMP_POS_60_THRES_MINUS_X_DEGREE 42
	// >55
#define TEMP_POS_55_THRESHOLD  55
#define TEMP_POS_55_THRES_MINUS_X_DEGREE 42
	// >45
#define TEMP_POS_45_THRESHOLD  45
#define TEMP_POS_45_THRES_MINUS_X_DEGREE 42
	// >-10

 ...
 *  Arima Feature
 ****************************************************************************/
//<2016/12/23-nickygao, [LV3][MISC][COMMON][BSP][][]Enable function of Thermal Charger control
#if 1
// + 20161107 Rody [D6][FEATURE][COMMON][BATTERY][][] Thermal Charger control
#define ARIMA_THERMAL_CONTROL_CURRENT 1
// - 20161107 Rody [D6][FEATURE][COMMON][BATTERY][][] Thermal Charger control
#endif
//<2016/12/23-nickygao
...
typedef struct {
	...
	kal_bool temperswitch_enable;
	// >>> 20160912 Rody [D6][PORTING][COMMON][BATTERY][][] add property to enable disable JEITA function
	// + 20161107 Rody [D6][FEATURE][COMMON][BATTERY][][] Thermal Charger control
#ifdef ARIMA_THERMAL_CONTROL_CURRENT
	unsigned int charge_option_mode;
	unsigned int charge_option_times;
	unsigned int charge_option_usb500mode_times;
	unsigned int charge_option_tamode_times;
#endif
	// - 20161107 Rody [D6][FEATURE][COMMON][BATTERY][][] Thermal Charger control
...
struct battery_custom_data {
	...
	//<2016/12/1-nickygao, [LV3][MISC][COMMON][BSP][][]Add full battery voltage

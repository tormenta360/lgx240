...
// <<< 20160920 Rody [LV3][PORTING][COMMON][BATTERY][][]Up ZCV Table
/* Qmax for battery  */
#define Q_MAX_POS_50	2458
#define Q_MAX_POS_25	2404
#define Q_MAX_POS_0		1782
#define Q_MAX_NEG_10	951

#define Q_MAX_POS_50_H_CURRENT	2473
#define Q_MAX_POS_25_H_CURRENT	2432
#define Q_MAX_POS_0_H_CURRENT	2248
#define Q_MAX_NEG_10_H_CURRENT	1967
// >>> 20160920 Rody [LV3][PORTING][COMMON][BATTERY][][]Up ZCV Table
...
//#define FIXED_TBAT_25
*/
// <<< 2016/08/29-dyro, [LV3][PORTING][COMMON][BATTERY][][]Remove Temperature Fixed 25 centigrade
// <<< 2016/08/10-youchihwang, [LV3][PORTING][COMMON][BATTERY][][]Have to revert this temporary solution, after related setting finish
//#define CONFIG_DIS_CHECK_BATTERY
//#define FIXED_TBAT_25
// >>> 2016/08/10-youchihwang, [LV3][PORTING][COMMON][BATTERY][][]Have to revert this temporary solution, after related setting finish
// >>> 2016/08/29-dyro, [LV3][PORTING][COMMON][BATTERY][][]Remove Temperature Fixed 25 centigrade

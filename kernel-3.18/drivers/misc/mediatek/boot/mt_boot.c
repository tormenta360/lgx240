...
//<2016/08/19-stevenchen, Create proc/lcm_vendor to distinguish LCM vendor
#include <mt-plat/mt_gpio.h>
#define GPIO_LCM_ID_PIN 67
//>2016/08/19-stevenchen
...
static int proc_lcm_vendor_show(struct seq_file *m, void *v)
{
    ...
    if(lcm_id == 0)
    {
    	seq_printf(m, "Truly LCM\n");         
    }
    else
    {
        //<2017/02/02-tracychui,modify second source LCM vendor name        
    	//seq_printf(m, "Innolux LCM\n");
    	seq_printf(m, "HLT LCM\n");
		//>2017/02/02-tracychui
    }

...
// <<< 2016/08/05-dangyiwang. Flashlight. Porting LM3648TT driver. Creating flashlight driver attributes.
extern struct i2c_client *LM3642_i2c_client;
extern int LM3642_write_reg(struct i2c_client *client, u8 reg, u8 val);
...
static ssize_t rear_torchmode_on_show (struct device *dev, struct device_attribute *attr, char *buf)
{
        ...
        // Bit 01 ~ 00 : LED Enable // 00 : disable // 11 : enable // 01 & 10 : not valid
        //
...
static void Lbat_protection_powerlimit_flash(LOW_BATTERY_LEVEL level)
{
	...
	if (level == LOW_BATTERY_LEVEL_0) {
		...
		// + Remove closeFlash(). By Ted Li. 2016-11-18
		//closeFlash();
		// - Remove closeFlash(). By Ted Li. 2016-11-18
...
static int __init flashlight_init(void)
{
	...
	// + Disable the low battery protection for flashlight. By Ted Li. 2016-11-25
/*	

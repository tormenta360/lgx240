...
WLAN_STATUS wlanLoadManufactureData(IN P_ADAPTER_T prAdapter, IN P_REG_INFO_T prRegInfo)
{
	...
	//solar, 20161109, [D6][MISC][COMMON][WIFI][][]Disable WIFI 5GHz Band support at the boot stage - start
	#if 0
	if (1) {
	#else
	if (0) {
	#endif
	//solar, 20161109, [D6][MISC][COMMON][WIFI][][]Disable WIFI 5GHz Band support at the boot stage - end

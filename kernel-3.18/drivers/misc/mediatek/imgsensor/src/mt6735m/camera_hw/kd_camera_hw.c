...
//<2016/08/11-louisliu, Camera. Porting S5K5E2YA driver.
	if (On) {
		...
		if( currSensorName && ( 0 == strcmp( SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW, currSensorName ))) {
			...
			PK_DBG("kdCISModulePowerOn--ON get in--- SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW \n");

			if( DUAL_CAMERA_SUB_SENSOR != SensorIdx ) {
				PK_DBG("--- SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW - is sub sensor! Skip power on.\n");
			...
			if(( pinSetIdx == 0 ) || ( pinSetIdx == 2 )) {
				...
				if( GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMPDN] ) {
					if( mtkcam_gpio_set( pinSetIdx, CAMPDN, pinSet[1][IDX_PS_CMPDN + IDX_PS_OFF] ))
						PK_DBG("[CAMERA LENS] set gpio failed!! \n");   /* high == power down lens module */
				}

				if( GPIO_CAMERA_INVALID != pinSet[1][IDX_PS_CMRST] ) {
					if( mtkcam_gpio_set( pinSetIdx, CAMRST, pinSet[1][IDX_PS_CMRST + IDX_PS_OFF] ))
				  		PK_DBG("[CAMERA SENSOR] set gpio failed!! \n"); /* low == reset sensor */
				}
			} else {
				if( GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMPDN] ) {
					if( mtkcam_gpio_set( pinSetIdx, CAMPDN, pinSet[0][IDX_PS_CMPDN + IDX_PS_OFF] ))
						PK_DBG("[CAMERA LENS] set gpio failed!! \n");   /* high == power down lens module */
					}
				if( GPIO_CAMERA_INVALID != pinSet[0][IDX_PS_CMRST] ) {
					if( mtkcam_gpio_set( pinSetIdx, CAMRST,pinSet[0][IDX_PS_CMRST + IDX_PS_OFF] ))
						PK_DBG("[CAMERA SENSOR] set gpio failed!! \n"); /* low == reset sensor */
				}
			}
			...
			if( GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN] ) {
				PK_DBG("--- SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW - init set pdn \n");
				if( mtkcam_gpio_set( pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF] ))
					PK_DBG("[CAMERA LENS] set power down gpio failed!! \n");
				mdelay( 2 );
			}

			/* RST pin */
			if( GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST] ) {
				PK_DBG("--- SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW - init set rst \n");
				if( mtkcam_gpio_set( pinSetIdx, CAMRST, pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_OFF] ))
					PK_DBG("[CAMERA SENSOR] set reset gpio failed!! \n");
				mdelay( 10 );
			}
			...
			/* PDN/STBY pin */
			if( GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN] ) {
				if( mtkcam_gpio_set( pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_ON] ))
					PK_DBG("[CAMERA LENS] set gpio failed!! \n");
				mdelay( 5 );
			}
			...
			/* RST pin */
			if( GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST] ) {
				if( mtkcam_gpio_set( pinSetIdx, CAMRST, pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_ON] ))
					PK_DBG("[CAMERA SENSOR] set gpio failed!! \n");
				mdelay( 10 );
			}

			mdelay( 50 );
//<2016/08/15-louisliu, Camera. Porting S5K3L8 driver.
		}else if(currSensorName && ( 0 == strcmp( SENSOR_DRVNAME_S5K3L8_MIPI_RAW, currSensorName ))) {
			PK_DBG("kdCISModulePowerOn--ON get in--- SENSOR_DRVNAME_S5K3L8_MIPI_RAW \n");

			if( DUAL_CAMERA_MAIN_SENSOR != SensorIdx ) {
				PK_DBG("--- SENSOR_DRVNAME_S5K3L8_MIPI_RAW - is main sensor! Skip power on.\n");
				goto _kdCISModulePowerOn_exit_;
			}
			...
			/* PDN/STBY pin */
			if( GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMPDN] ) {
				PK_DBG("--- SENSOR_DRVNAME_S5K3L8_MIPI_RAW - init set pdn \n");
				if( mtkcam_gpio_set( pinSetIdx, CAMPDN, pinSet[pinSetIdx][IDX_PS_CMPDN + IDX_PS_OFF] ))
					PK_DBG("[CAMERA LENS] set power down gpio failed!! \n");
				mdelay( 2 );
			}
			...
			/* RST pin */
			if( GPIO_CAMERA_INVALID != pinSet[pinSetIdx][IDX_PS_CMRST] ) {
				PK_DBG("--- SENSOR_DRVNAME_S5K3L8_MIPI_RAW - init set rst \n");
				if( mtkcam_gpio_set( pinSetIdx, CAMRST, pinSet[pinSetIdx][IDX_PS_CMRST + IDX_PS_OFF] ))
					PK_DBG("[CAMERA SENSOR] set reset gpio failed!! \n");
				mdelay( 10 );
			}
...
//>2016/08/15-louisliu
		...
		if( currSensorName && ( 0 == strcmp( SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW, currSensorName ))) {
			...
			PK_DBG("kdCISModulePowerOn--OFF get in--- SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW \n");

			if( DUAL_CAMERA_SUB_SENSOR != SensorIdx ) {
				PK_DBG("--- SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW - is sub sensor! Skip power off.\n");
				goto _kdCISModulePowerOn_exit_;
			}
...
//<2016/08/15-louisliu, Camera. Porting S5K3L8 driver.
			...
			PK_DBG("kdCISModulePowerOn--OFF get in--- SENSOR_DRVNAME_S5K3L8_MIPI_RAW \n");

			if( DUAL_CAMERA_MAIN_SENSOR != SensorIdx ) {
				PK_DBG("--- SENSOR_DRVNAME_S5K3L8_MIPI_RAW - is main sensor! Skip power off.\n");
				goto _kdCISModulePowerOn_exit_;
			}

...
//20160901 Neil for otp awb +
static int OTP_Group;
//20160901 Neil for otp awb +
...
/*static */struct S5K5E2YA_MIPI_otp_struct
{
...
void S5K5E2YA_MIPI_read_otp_wb(struct S5K5E2YA_MIPI_otp_struct *otp)
{
	...
	for(PageCount = 3; PageCount>=2; PageCount--)
	{
		...
		write_cmos_sensor(0x0a02, PageCount); //otp enable read
		write_cmos_sensor(0x0a00, 0x01); //otp enable read

        #if 1
        //====================
        LOG_INF("[otp_log] PageCount=%x\n", PageCount);	
        
        LOG_INF("[otp_log] Flag=0x%x\n", read_cmos_sensor(0x0a04));	
        LOG_INF("[otp_log] Lens ID=0x%x\n", read_cmos_sensor(0x0a05));	
        LOG_INF("[otp_log] Module ID=0x%x\n", read_cmos_sensor(0x0a06));	
        LOG_INF("[otp_log] Structure Version=0x%x\n", read_cmos_sensor(0x0a07));	
        LOG_INF("[otp_log] AF_Macro[0:7]=0x%x\n", read_cmos_sensor(0x0a08));	
        LOG_INF("[otp_log] AF_Macro[8:15]=0x%x\n", read_cmos_sensor(0x0a09));	
        LOG_INF("[otp_log] AF_Infinity[0:7]=0x%x\n", read_cmos_sensor(0x0a0a));	
        LOG_INF("[otp_log] AF_Infinity[8:15]=0x%x\n", read_cmos_sensor(0x0a0b));	
        LOG_INF("[otp_log] AF_Starting[0:7]=0x%x\n", read_cmos_sensor(0x0a0c));	
        LOG_INF("[otp_log] AF_Starting[8:15]=0x%x\n", read_cmos_sensor(0x0a0d));	
        LOG_INF("[otp_log] AWB_R_Over_G=0x%x\n", read_cmos_sensor(0x0a0e));	
        LOG_INF("[otp_log] AWB_B_Over_G=0x%x\n", read_cmos_sensor(0x0a0f));	
        LOG_INF("[otp_log] AWB_Gr_Over_Gb=0x%x\n", read_cmos_sensor(0x0a10));	
        LOG_INF("[otp_log] Unit-AWB-R=0x%x\n", read_cmos_sensor(0x0a11));	
        LOG_INF("[otp_log] Unit-AWB-Gr=0x%x\n", read_cmos_sensor(0x0a12));	
        LOG_INF("[otp_log] Unit-AWB-Gb=0x%x\n", read_cmos_sensor(0x0a13));	
        LOG_INF("[otp_log] Unit-AWB-B=0x%x\n", read_cmos_sensor(0x0a14));	
        LOG_INF("[otp_log] Golden-AWB-R=0x%x\n", read_cmos_sensor(0x0a15));	
        LOG_INF("[otp_log] Golden-AWB-Gr=0x%x\n", read_cmos_sensor(0x0a16));	
        LOG_INF("[otp_log] Golden-AWB-Gb=0x%x\n", read_cmos_sensor(0x0a17));	
        LOG_INF("[otp_log] Golden-AWB-B=0x%x\n", read_cmos_sensor(0x0a18));
        
        LOG_INF("[otp_log] Flag=0x%x\n", read_cmos_sensor(0x0a24));	
        LOG_INF("[otp_log] Lens ID=0x%x\n", read_cmos_sensor(0x0a25));	
        LOG_INF("[otp_log] Module ID=0x%x\n", read_cmos_sensor(0x0a26));	
        LOG_INF("[otp_log] Structure Version=0x%x\n", read_cmos_sensor(0x0a27));	
        LOG_INF("[otp_log] AF_Macro[0:7]=0x%x\n", read_cmos_sensor(0x0a28));	
        LOG_INF("[otp_log] AF_Macro[8:15]=0x%x\n", read_cmos_sensor(0x0a29));	
        LOG_INF("[otp_log] AF_Infinity[0:7]=0x%x\n", read_cmos_sensor(0x0a2a));	
        LOG_INF("[otp_log] AF_Infinity[8:15]=0x%x\n", read_cmos_sensor(0x0a2b));	
        LOG_INF("[otp_log] AF_Starting[0:7]=0x%x\n", read_cmos_sensor(0x0a2c));	
        LOG_INF("[otp_log] AF_Starting[8:15]=0x%x\n", read_cmos_sensor(0x0a2d));	
        LOG_INF("[otp_log] AWB_R_Over_G=0x%x\n", read_cmos_sensor(0x0a2e));	
        LOG_INF("[otp_log] AWB_B_Over_G=0x%x\n", read_cmos_sensor(0x0a2f));	
        LOG_INF("[otp_log] AWB_Gr_Over_Gb=0x%x\n", read_cmos_sensor(0x0a30));	
        LOG_INF("[otp_log] Unit-AWB-R=0x%x\n", read_cmos_sensor(0x0a31));	
        LOG_INF("[otp_log] Unit-AWB-Gr=0x%x\n", read_cmos_sensor(0x0a32));	
        LOG_INF("[otp_log] Unit-AWB-Gb=0x%x\n", read_cmos_sensor(0x0a33));	
        LOG_INF("[otp_log] Unit-AWB-B=0x%x\n", read_cmos_sensor(0x0a34));	
        LOG_INF("[otp_log] Golden-AWB-R=0x%x\n", read_cmos_sensor(0x0a35));	
        LOG_INF("[otp_log] Golden-AWB-Gr=0x%x\n", read_cmos_sensor(0x0a36));	
        LOG_INF("[otp_log] Golden-AWB-Gb=0x%x\n", read_cmos_sensor(0x0a37));	
        LOG_INF("[otp_log] Golden-AWB-B=0x%x\n", read_cmos_sensor(0x0a38));	
        //====================
        #endif
        
		//GroupFlag = read_cmos_sensor(0x0a24);
		if(read_cmos_sensor(0x0a24) == 0x01)
		{
            OTP_Group = 24;
        
			if(PageCount==3)
				LOG_INF("[S5K5E2YA] otp Group=3\n");
			else
				LOG_INF("[S5K5E2YA] otp Group=1\n");
			otp->module_integrator_id = read_cmos_sensor(0x0a26);
			otp->R_to_G = read_cmos_sensor(0x0a2e);
			otp->B_to_G = read_cmos_sensor(0x0a2f);
			otp->Gr_to_Gb = read_cmos_sensor(0x0a30);
			otp->unit_awb_r = read_cmos_sensor(0x0a31);
			otp->unit_awb_gr = read_cmos_sensor(0x0a32);
			otp->unit_awb_gb = read_cmos_sensor(0x0a33);
			otp->unit_awb_b = read_cmos_sensor(0x0a34);
			otp->golden_awb_r = read_cmos_sensor(0x0a35);
			otp->golden_awb_gr = read_cmos_sensor(0x0a36);
			otp->golden_awb_gb = read_cmos_sensor(0x0a37);
			otp->golden_awb_b = read_cmos_sensor(0x0a38);

			write_cmos_sensor(0x0a00, 0x04);  //otp disable read
			write_cmos_sensor(0x0a00, 0x00);  //otp disable read
			break;
		}
		else if(read_cmos_sensor(0x0a04) == 0x01)
		{
            OTP_Group = 4;
            
			if(PageCount==3)
				LOG_INF("[S5K5E2YA] otp Group=2\n");
			else
				LOG_INF("[S5K5E2YA] otp Group=0\n");
			otp->module_integrator_id = read_cmos_sensor(0x0a06);
			otp->R_to_G = read_cmos_sensor(0x0a0e);
			otp->B_to_G = read_cmos_sensor(0x0a0f);
			otp->Gr_to_Gb = read_cmos_sensor(0x0a10);
			otp->unit_awb_r = read_cmos_sensor(0x0a11);
			otp->unit_awb_gr = read_cmos_sensor(0x0a12);
			otp->unit_awb_gb = read_cmos_sensor(0x0a13);
			otp->unit_awb_b = read_cmos_sensor(0x0a14);
			otp->golden_awb_r = read_cmos_sensor(0x0a15);
			otp->golden_awb_gr = read_cmos_sensor(0x0a16);
			otp->golden_awb_gb = read_cmos_sensor(0x0a17);
			otp->golden_awb_b = read_cmos_sensor(0x0a18);
		...
		{
			LOG_INF("[S5K5E2YA] There is no OTP data");
		}
		write_cmos_sensor(0x0a00, 0x04);  //otp disable read
		write_cmos_sensor(0x0a00, 0x00);  //otp disable read
	}
	...
	if(PageCount == 1)
	{
		LOG_INF("[S5K5E2YA] otp all value is zero");
		write_cmos_sensor(0x0a00, 0x04);  //otp disable read
		write_cmos_sensor(0x0a00, 0x00);  //otp disable read
	}

	LOG_INF("[S5K5E2YA] otp->ModuleID=0x%x\n", otp->module_integrator_id);	
	LOG_INF("[S5K5E2YA] otp->unit_awb_r=0x%x\n", otp->unit_awb_r);	
	LOG_INF("[S5K5E2YA] otp->unit_awb_b=0x%x\n", otp->unit_awb_b);	
	LOG_INF("[S5K5E2YA] otp->unit_awb_gr=0x%x\n", otp->unit_awb_gr);
	LOG_INF("[S5K5E2YA] otp->unit_awb_gb=0x%x\n", otp->unit_awb_gb);	

	LOG_INF("[S5K5E2YA] otp->golden_awb_r=0x%x\n", otp->golden_awb_r);	
	LOG_INF("[S5K5E2YA] otp->golden_awb_b=0x%x\n", otp->golden_awb_b);	
	LOG_INF("[S5K5E2YA] otp->golden_awb_gr=0x%x\n", otp->golden_awb_gr);
	LOG_INF("[S5K5E2YA] otp->golden_awb_gb=0x%x\n", otp->golden_awb_gb);	
}

void S5K5E2YA_MIPI_algorithm_otp_wb1(struct S5K5E2YA_MIPI_otp_struct *otp)
{
	kal_uint32 rg_ratio_unit=0, bg_ratio_unit=0;
	kal_uint32 R_Gain, B_Gain, G_Gain;
	kal_uint32 G_gain_R, G_gain_B;
	kal_uint32 bg_ratio_typical,rg_ratio_typical;
	
	if((otp->unit_awb_b == 0) || (otp->unit_awb_b == 0) || (otp->unit_awb_gr == 0))
	{
		rg_ratio_typical = RG_TYPICAL;
		bg_ratio_typical = BG_TYPICAL;
	}else{
		rg_ratio_unit = (1000*otp->unit_awb_r)/otp->unit_awb_gr;
		bg_ratio_unit = (1000*otp->unit_awb_b)/otp->unit_awb_gr;
	}
	
	LOG_INF("[S5K5E2YA] rg_ratio_unit=%d\n", rg_ratio_unit);	
	LOG_INF("[S5K5E2YA] bg_ratio_unit=%d\n", bg_ratio_unit);	
	...
	LOG_INF("[S5K5E2YA] bg_ratio_typical=%d\n", bg_ratio_typical);	
	LOG_INF("[S5K5E2YA] rg_ratio_typical=%d\n", rg_ratio_typical);	

	if(bg_ratio_unit < bg_ratio_typical)
		{
			if(rg_ratio_unit < rg_ratio_typical)
				{
					G_Gain = 0x100;
					B_Gain = 0x100 * bg_ratio_typical/ bg_ratio_unit;
					R_Gain = 0x100 * rg_ratio_typical/ rg_ratio_unit;
				}
			else
				{
			        R_Gain = 0x100;
					G_Gain = 0x100 * rg_ratio_unit / rg_ratio_typical;
					B_Gain = G_Gain * bg_ratio_typical/ bg_ratio_unit;	        
				}
		}
	else
		{
			if(rg_ratio_unit < rg_ratio_typical)
				{
			        B_Gain = 0x100;
					G_Gain = 0x100 * bg_ratio_unit / bg_ratio_typical;
					R_Gain = G_Gain * rg_ratio_typical/ rg_ratio_unit;
				}
			else
				{
			        G_gain_B = 0x100*bg_ratio_unit / bg_ratio_typical;
				    G_gain_R = 0x100*rg_ratio_unit / rg_ratio_typical;
	...
	LOG_INF("[S5K5E2YA] R_gain=0x%x\n", otp->R_Gain);	
	LOG_INF("[S5K5E2YA] B_gain=0x%x\n", otp->B_Gain);	
	LOG_INF("[S5K5E2YA] G_gain=0x%x\n", otp->G_Gain);
}
...
void S5K5E2YA_MIPI_write_otp_wb(struct S5K5E2YA_MIPI_otp_struct *otp)
{
    ...
    //2015/08/17 c +, reopen OTP AWB
    //if(read_cmos_sensor(0x0a07) == 0xa) // suggestion by wayne lin

//20160902 Neil for AWB OTP +
#if 0	
    if((OTP_Group == 4 && read_cmos_sensor(0x0a07) == 0xa) || (OTP_Group == 24 && read_cmos_sensor(0x0a27) == 0xa))
    {
#endif    
//20160902 Neil for AWB OTP -
        LOG_INF("[otp_log] ====> write_cmos_sensor, OTP_Group = [0x%d] <==== \n", OTP_Group);
...
//20160902 Neil for AWB OTP +
    ...
    {
        LOG_INF("[otp_log] ====> no write OTP_Group = [0] <==== \n");
    }
#endif	
//20160902 Neil for AWB OTP -
	...
	LOG_INF("[S5K5E2YA] [0x020e,0x%x]\n", read_cmos_sensor(0x020e));	
	LOG_INF("[S5K5E2YA] [0x020f,0x%x]\n", read_cmos_sensor(0x020f));	
	LOG_INF("[S5K5E2YA] [0x0210,0x%x]\n", read_cmos_sensor(0x0210));
	LOG_INF("[S5K5E2YA] [0x0211,0x%x]\n", read_cmos_sensor(0x0211));	
	LOG_INF("[S5K5E2YA] [0x0212,0x%x]\n", read_cmos_sensor(0x0212));	
	LOG_INF("[S5K5E2YA] [0x0213,0x%x]\n", read_cmos_sensor(0x0213));
	LOG_INF("[S5K5E2YA] [0x0214,0x%x]\n", read_cmos_sensor(0x0214));	
	LOG_INF("[S5K5E2YA] [0x0215,0x%x]\n", read_cmos_sensor(0x0215));
}
...
//<2016/08/03-louisliu, Camera. Porting S5K5E2YA driver. Fix build error.
#if 0
...
static void sensor_init(void)
{
   ...
   // +++++++++++++++++++++++++++//                                                               
	...
	//************
    write_cmos_sensor(0x0B00,0x01);       // GAS bypass
	//************
                      
	write_cmos_sensor(0x3400,0x00);       //  GAS bypass                                      

...
#endif
//[LGLV3] zihweishen add store touch vendor and firmware begin 2016/7/18
...
//[LGLV3] zihweishen add store touch vendor and firmware end 2016/7/18
...
struct tpd_driver_t {
	...
	int tpd_have_button;
	struct platform_driver* platform_driv_addr;

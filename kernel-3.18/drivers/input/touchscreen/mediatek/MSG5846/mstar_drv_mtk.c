...
//20170410 tracy,modify for enable charge detection 
...
//    const char *vcc_i2c_name = "vcc_i2c";
    ...
    MsDrvInterfaceTouchDeviceSetIicDataRate(g_I2cClient, 400000); // 400 KHz
    //- murphy 2017.01.24  change I2C speed to 400KHz
...
static int __init tpd_driver_init(void) 
{
    ...
    {
        printk("TPD add MStar TP driver failed\n");
    }

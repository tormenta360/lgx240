...
extern int fts_i2c_test_write(unsigned char *wBuf, int wLen);
extern int fts_i2c_test_read(unsigned char *wBuf, int wLen, unsigned char *rBuf, int rLen);
//20160527 tracy add for 5700 auto test function end
//<2016/09/20-tracychui,[D6][BUG][COMMON][TOUCH][][]Fix phone reset when get AATS test result value
//20160604 tracy add for fixed 5700 touch auto test function shutdown start
extern int fts_test_result(int value);
//20160604 tracy add for fixed 5700 touch auto test function shutdown end
//>2016/09/20-tracychui
/*******************************************************************************

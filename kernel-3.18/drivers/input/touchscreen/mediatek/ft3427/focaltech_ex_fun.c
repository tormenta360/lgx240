...
{
   test_result=0;
   printk("tracy:fts_test_result=%d\n",value);
   test_result=value;
   return 0;
}
//>2016/09/20-tracychui
...
//<2016/09/20-tracychui,[D6][BUG][COMMON][TOUCH][][]Fix phone reset when get AATS test result value
static ssize_t fts_test_check_result(struct device *dev,
				  struct device_attribute *attr, char *buf)
{
    ...
    printk("tracy:fts_test_check_result=%d\n",test_result);
...
//<2016/09/20-tracychui,[D6][BUG][COMMON][TOUCH][][]Fix phone reset when get AATS test result value
static DEVICE_ATTR(fts_test_result, S_IRUGO, fts_test_check_result, NULL);

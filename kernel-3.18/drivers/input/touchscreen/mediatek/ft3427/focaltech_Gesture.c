...
int fts_Gesture_init(struct input_dev *input_dev)
{
    ...
    //[D6][calvin] modify knock on function key value 20161005 +
    input_set_capability(input_dev, EV_KEY, KEY_YEN);
    //[D6][calvin] modify knock on function key value 20161005 -
...
//[LG D6][zihweishen] 2016/09/1 end
            #else
                    input_report_key(input_dev, KEY_YEN, 1);
	                input_sync(input_dev);
	                input_report_key(input_dev, KEY_YEN, 0);
	                input_sync(input_dev);
            #endif
            //[D6][calvin] modify knock on function key value 20161005 -
	                break;

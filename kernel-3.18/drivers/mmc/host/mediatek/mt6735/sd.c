...
//<2016/08/15 -stevenchen, Create proc/emmc_vendor to show emmc vendor info.
...
static int proc_emmc_vendor_show(struct seq_file *m, void *v)
{
	...
	printk("[Steven][Kernel] %s, line=%d, emmc_manfid = 0x%x", __func__, __LINE__, emmc_manfid);
	if(emmc_manfid == SAMSUNG_EMMC_CHIP)
	{
		seq_printf(m, "Samsung KMQ310006A_B419\n");         
	}
	//else
	//{
	//	seq_printf(m, "Hynix H9TQ17ABJTMCUR,16GB+16Gb\n");          
	//}

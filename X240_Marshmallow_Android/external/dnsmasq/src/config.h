...
/*<2016/10/22-d240-shuaishuai.gu,[LV3][LV1][COMMON][MEX TELCEL][TD356]Change the Lease time from 1h to 2h.*/
/*
#define DEFLEASE 3600
*/
#define DEFLEASE 7200 /* default lease time, 2 hour */
/*>2016/10/22 shuaishuai.gu*/
